\batchmode
\documentclass[twoside,11pt]{aghdpl}
...
\titlePL{Klasteryzacja tematów aktywności użytkowników w sieci społecznościowej}
\titleEN{Clustering topics of user activity in social networking service}

\shorttitlePL{Klasteryzacja tematów aktywności użytkowników w sieci społecznościowej}
\shorttitleEN{Clustering topics of user activity in social networking service}
